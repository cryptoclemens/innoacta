...
const icons = [
  (
    <svg viewBox="0 0 48 48" fill="none" className="w-10 h-10">
      <rect width="48" height="48" rx="4" fill="#0f766e" fillOpacity="0.1" />
      <path d="M24 12L36 19V29L24 36L12 29V19L24 12Z" stroke="#0f766e" strokeWidth="2" fill="none" />
      <path d="M24 18L30 21.5V28.5L24 32L18 28.5V21.5L24 18Z" fill="#0f766e" fillOpacity="0.3" />
  ...
  (
    <svg viewBox="0 0 48 48" fill="none" className="w-10 h-10">
      <rect width="48" height="48" rx="4" fill="#0f766e" fillOpacity="0.1" />
      <path d="M14 24H34M14 17H26M14 31H22" stroke="#0f766e" strokeWidth="2" strokeLinecap="round" />
      <circle cx="35" cy="31" r="5" stroke="#0f766e" strokeWidth="2" />
      <path d="M35 29V31L36.5 32.5" stroke="#0f766e" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
  (
    <svg viewBox="0 0 48 48" fill="none" className="w-10 h-10">
      <rect width="48" height="48" rx="4" fill="#0f766e" fillOpacity="0.1" />
      <rect x="12" y="20" width="10" height="16" rx="2" stroke="#0f766e" strokeWidth="2" />
      <rect x="26" y="14" width="10" height="22" rx="2" stroke="#0f766e" strokeWidth="2" />
      <path d="M12 36H36" stroke="#0f766e" strokeWidth="2" strokeLinecap="round" />
      <path d="M17 16L17 20" stroke="#0f766e" strokeWidth="2" strokeLinecap="round" />
      <path d="M31 10L31 14" stroke="#0f766e" strokeWidth="2" strokeLinecap="round" />
    </svg>
  ),
]
