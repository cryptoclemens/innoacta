...
const icons = [
  (
    <svg viewBox="0 0 48 48" fill="none" className="w-10 h-10">
      ...
      <path d="M24 12L36 19V29L24 36L12 29V19L24 12Z" stroke="#14b8a6" strokeWidth="2" fill="none" />
      <path d="M24 18L30 21.5V28.5L24 32L18 28.5V21.5L24 18Z" fill="#14b8a6" fillOpacity="0.3" />
  ...
  (
    <svg viewBox="0 0 48 48" fill="none" className="w-10 h-10">
      <rect width="48" height="48" rx="12" fill="#14b8a6" fillOpacity="0.1" />
      <path d="M14 24H34M14 17H26M14 31H22" stroke="#14b8a6" strokeWidth="2" strokeLinecap="round" />
