// SVG placeholder logos – replace with real brand assets
const partnerLogos = [
...
export default function LogoBar() {
  return (
    <section className="bg-vencly-card border-t border-b border-vencly-border py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <p className="text-center text-gray-600 text-xs font-mono tracking-widest uppercase mb-8">
