        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              <span className="inline-block text-brand-teal dark:text-brand-mint text-sm font-mono tracking-widest uppercase">Venture Clienting · Plattform</span>
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
              Innovation Republic –{' '}
              <span className="text-brand-teal dark:text-brand-mint">Startup-Matching</span> auf Knopfdruck.
            </h1>
