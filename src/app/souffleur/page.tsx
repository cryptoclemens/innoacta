        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              <span className="inline-block text-brand-teal dark:text-brand-mint text-sm font-mono tracking-widest uppercase">KI-Verhandlungs-Coach · macOS</span>
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
              Souffleur –{' '}
              <span className="text-brand-teal dark:text-brand-mint">Verhandlungs-Coach</span> der auf Ihrer Seite sitzt.
            </h1>
          ...
          <section className="mb-16">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                <div key={label} className="bg-white dark:bg-brand-card border border-gray-200 dark:border-brand-border rounded p-4 text-center">
