        ...
        <div className="bg-white dark:bg-vencly-card border border-gray-200 dark:border-vencly-border rounded p-8">
          {step === 0 && (
            <>
              ...
              <input
                className="w-full px-3 py-2 text-sm rounded border border-gray-200 dark:border-vencly-border bg-transparent text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-vencly-teal"
